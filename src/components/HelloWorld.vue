<template>
  ...
  <div class = "bg" id="app">
    ...
    <!-- HEADER -->
    <h1 style="max-width: 1000px; margin: 0 auto; padding-top: 40px; padding-bottom: 20px;text-align: center; color: rgb(219, 126, 27);">Welcome to my Vue 3 Concepts using Composition API with Single File Components</h1>
    ...
    <div class="VConcepts">
      ...
      <p><strong>Welcome to my app, {{ username }} !!🎉</strong></p>
    ...
    <div class="VConcepts">
      ...
      <p>Character length: {{ textLength }}</p>
    ...
    <div class="VConcepts">
      ...
      <!-- Create variables to track the active and text-bold states -->
      <p :class="{'text-bold': isTextBold }">This text can have dynamic classes</p>

      <!-- Button to toggle the 'text-bold' class -->
      <button @click="toggleTextBold">Toggle Text Bold Class</button>
    ...
    <div class="VConcepts">
      ...
      <strong>Presentation of the website is: {{ checkedNames }}</strong>
    ...
    <div class="VConcepts">
      ...
      <p style="background-color: bisque;">SEE ABOVE</p>
